...
TEMAS = [
  {
    ...
    'Desarrollo': '<b>Situación 1:</b><br><br>Juan quiere comprar una motocicleta y existen 3 diferentes marcas que le interesan: Xioma, Serpux y Ziron. Juan consultó en internet cuántas motocicletas de cada marca han sido llevadas a servicio a la tienda en los últimos tres meses por fallas y mal funcionamiento. Los resultados fueron los siguiente:<br><br><div class="border-bottom row mx-auto text-center"><div class="col-4">Serpux:</div> <div class="col-4">Xioma:</div>  <div class="col-4">Ziron:</div></div><div class="border-bottom row mx-auto text-center"><div class="col-4">0</div> <div class="col-4">1</div>  <div class="col-4">4</div></div><br><br><div class="actividad"><b>Actividad 2</b><br> En hoja con tus datos escribe la <b>Situación 1</b> así como también los datos de la tabla de marcas de motocicletas, después escribe las siguientes preguntas y con tus propias palabras desarrolla la respuesta de cada una.<br><br>1. ¿Cuál marca presentó fallas con menor <b>frecuencia</b>?<br>2. ¿Cuál marca crees que es la que presenta fallas con mayor <b>frecuencia</b>?<br>3. ¿Cuál marca crees que tiene mayor <b>probabilidad</b> de fallar?¿Por qué?<br>4. ¿Cuál marca crees que debería comprar Juán y por qué?<br><br><p class="navtxt"><b>*Frecuencia</b> se refiere al <b>número</b> de veces que un evento se repite.</p><br><br>Antes de entregar tu actividad al profesor toma una foto de la misma y como <b>Tarea 1</b> deberás enviar la foto de la actividad por medio de correo electrónico utilizando el botón <i>"Enviar actividad"</i> que está abajo en la parte final de este recuadro. <b>*La fecha límite para enviar la Tarea 1 es el viernes 5 de septiembre a las 09:00 PM.</b></div>',
