...
TEMAS = [
  {
    ...
    'Temática específica': 'Los números y la información como respaldo en las decisiones',
    'Semestre': '1°',
    'Grupos': 'A, B y C',
