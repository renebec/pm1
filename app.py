...
TEMAS = [
  {
    ...
    'Resuelve': '',
    'Retroalimentación': '  <b>Retroalimentación:</b><br><ul>   <li>Recuerda que el término <b>Frecuencia</b> se refiere al número de veces que se presenta un evento.</li>   <li>Es importante que pongan atención en las lecturas, sobre todo a la hora de identificar a los personajes principales, la problemática que presenta y la manera en que dicha problemática se resolvió</li>   <li>No olvides guardar tus datos de correo electrónico para el envío de tus actividades. El correo electrónico es una herramienta que usarás mucho posteriormente como ciudadano y en la vida profesional.</li></ul>  '
  },
