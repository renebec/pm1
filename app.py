...
TEMAS = [
  {
    ...
    'Laboratorio':'<p style="font-weight:bold;">Laboratorio</p> Esta sección se trabajará en el laboratorio de cómputo donde exploraremos el uso del lenguaje de programación "R".<br><br>Después de que Juan obtuvo la información antes mostrada, se dió a la tarea de buscar en internet acerca de más casos de fallas. En la página de PROFECO encontró un reporte con información de la cantidad de motocicletas reportadas como defectuosas dentro de las últimas 200 motocicletas vendidas de cada marca. La lista es la siguiente:<br><br>"Ziron", "Ziron" ,"Ziron", "Serpux", "Ziron", "Ziron", "Ziron", "Xioma", "Ziron", "Ziron", "Xioma", "Serpux", "Ziron", "Xioma", "Ziron", "Ziron", "Xioma", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Serpux", "Ziron", "Xioma", "Ziron", "Ziron", "Ziron", "Serpux", "Ziron", "Serpux", "Ziron", "Ziron" <br><br>Ahora usa un navegador de internet e ingresa al sitio <a href="https://rdrr.io/snippets/" target="_blank">rdrr</a>. Una vez que abras esta liga verás una pantalla como la siguiente:<br><br><img class="mt-3 mb-3" src="https://matematicas-1.onrender.com/static/rdrr_interfase.jpg"><br><br>Resaltan dos secciones importantes, una es la <b>ventana de código</b> donde escribiremos instrucciones y en la parte de abajo hay un <b>botón</b> de color verde con una etiqueta que dice "<i>Run (Ctrl-Enter)</i>".<br><br>Como podrás ver, la ventana de código ya tiene algunas lineas de instrucciones escritas. Selecciona todo lo que aparece en la ventana de código y bórralo. Ahora escribiremos lo siguiente:<br><br>&emsp;<b>reportes=c(&emsp;)</b><br><br>Ahora, de esta página del curso, copia la lista con los casos reportados de motocicletas defectuosas (no olvides incluir las comillas) y pega la información enmedio de los paréntesis:<br><br>&emsp;<b>reportes=c("Ziron", "Ziron" ,"Ziron", "Serpux", "Ziron", "Ziron", "Ziron", "Xioma", "Ziron", "Ziron", "Xioma", "Serpux", "Ziron", "Xioma", "Ziron", "Ziron", "Xioma", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Ziron", "Serpux", "Ziron", "Xioma", "Ziron", "Ziron", "Ziron", "Serpux", "Ziron", "Serpux", "Ziron", "Ziron")</b><br><br>Una vez hecho esto escribe en una linea debajo el siguiente código:<br><br>&emsp;<b>table(reportes)</b><br><br>Ahora, en una nueva linea escribe el siguiente código:<br><br>&emsp;<b>barplot(table(reportes))</b><br><br>EL código debe verse más o menos de la siguiente manera:<br><br><img class="mt-3 mb-3" src="https://matematicas-1.onrender.com/static/rdrr_01.jpg"><br><br>Una vez que has ingresado el código y que verifiques que no tenga ninún error de escritura (debes respetar cada coma, comillas, paréntesis y los espacios entre las líneas de código) ahora haz click sobre el <b>botón</b> y después de unos segundos aparecerá en la parte de abajo el siguiente resultado:<br><br><img class="mt-3 mb-3" src="https://matematicas-1.onrender.com/static/rdrr_02.jpg"><br><br>Con ayuda de tu profesor interpreta los resultados de la <b>tabla</b> generada así como de la <b>gráfica de barras</b>. Has escrito tu primer <i>Script</i> en lenguaje "R", y aunque fue un ejemplo muy sencillo, más adelante irás conociendo más acerca de esta poderosa herramienta. Sobre todo aprenderas a simplificar tareas cuando es necesario analizar grandes cantidades de datos desde diferentes dimensiones. De igual manera, usando "R" como lenguaje, aprenderás a manejar información contenida en otros formatos como es el caso de Excel o archivos de tipo .txt o de tipo .csv.<br><br>',
    ...
    'Fuente2': 'https://rdrr.io/snippets/',
    'Fuente3': '',
